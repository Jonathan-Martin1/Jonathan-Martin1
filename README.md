...
A Full Stack Developer with a focus on web-based technologies. Proficient in
JavaScript(React.js/Node.js) mainly and constantly learning new programming languages
and frameworks. Efficient problem solver that can look at things from a unique
perspective. Works well on a team and loves learning new tips and tricks from others.
